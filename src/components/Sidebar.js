...
export default function Sidebar() {
  ...
  return (
    <div className="w-72 bg-gradient-to-r from-red-100 to-indigo-200 flex-none h-full overflow-y-auto flex flex-col items-start p-4 border-r border-gray-300 shadow-xl rounded-lg">
      <div className="text-xl font-semibold text-gray-800 mb-4">Moves</div>
      ...
      <div
        ...
        className="flex items-center gap-3 p-3 bg-red-500 text-white rounded-lg cursor-pointer hover:bg-red-600 transition-colors duration-300"
      >
        <span>Move</span>
        <input
          type="number"
      ...
      <div
        ...
        draggable
        onDragStart={handleDragStart}
        className="flex items-center gap-3 p-3 bg-red-500 text-white rounded-lg cursor-pointer hover:bg-red-600 transition-colors duration-300 mt-4"
      >
        <span>Turn</span>
        <input
          type="number"

...
function Header() {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-900 to-red-700 text-white py-4 px-6 shadow-lg rounded-b-lg">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-white">Scratch</h1>
